    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" aria-label="Eighth navbar example">
      <div class="container">
        <a class="navbar-brand" href="#">
          <img src="public/images/logistics-logo.jpg" alt="" width="auto" height="30px">
          <strong>Logistics Website</strong>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarsExample07">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="dropdown07">
                <li><a class="dropdown-item" href="#">Giao hàng nhanh</a></li>
                <li><a class="dropdown-item" href="#">Giao hàng hỏa tốc</a></li>
                <li><a class="dropdown-item" href="#">Giao hàng tiết kiệm</a></li>
              </ul>
            </li>
            <li class="nav-item">
          ...
          <form>
            <input class="form-control" type="text" placeholder="Tra cứu" aria-label="Search">
          </form>
          <?php
          if (isset($_SESSION['user_id'])) {
            echo '<a href="index.php?page=logout" class="btn btn-md btn-light fw-bold border-white mx-2">Đăng xuất</a>';
          } else {
            echo '<a href="index.php?page=login" class="btn btn-md btn-light fw-bold border-white mx-2">Đăng nhập</a>';
          }
          ?>
        </div>
      </div>
